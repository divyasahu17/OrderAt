          ...
          <Grid container item xs={10} sm={10} md={9}>
            <ol className={classes.termol}>
              ...
              <li>
                ...
                <Typography variant="body1" component="p" className={classes.MV3}>
                  These Terms of Use (“<b>Terms</b>”) govern your use of the websites and mobile applications provided
                  by Orderat (collectively the “<b>Platforms</b>”). Please read these Terms carefully. By accessing and
                ...
                <Typography variant="body1" component="p" className={classes.MV3}>
                  Orderat reserves the right to change or modify these Terms (including our policies which are
              ...
              <li>
                ...
                <ul className={classes.bullet}>
                  <li>
                    ...
                    <Typography variant="body1" component="p" className={classes.MV2}>
                      Through our Platforms, Orderat links you to the vendors (“<b>Vendors</b>”) for you to order a
                      ...
                      order for Goods from our Vendors (“<b>Order</b>”), Orderat acts as an agent on behalf of that
              ...
              <li>
                ...
                <Typography variant="body1" component="p">
                  You will need to register for a Orderat account for you to use the Platform. When you register for a
                  Orderat account we will ask you to provide your personal information including a valid email address,
                  ...
                  all Orders placed under your Orderat account are your sole responsibility.
                </Typography>
                <Typography variant="body1" component="p" className={classes.MV3}>
                  Orderat shall not be liable for Orders that encounter delivery issues due to incomplete, incorrect or
                ...
                <Typography variant="body1" component="p">
                  If you wish to delete your Orderat account, please send us an email requesting the same. We may
                  restrict, suspend or terminate your Orderat account and/or use of the Platforms, if we reasonably
                  believe that:
                </Typography>
                <Typography variant="body1" component="p" className={classes.MV3}>
              ...
              <li>
                ...
                <Typography variant="body1" component="p">
                  ...
                  Platforms. Orderat reserves the right to investigate and take appropriate legal action against anyone
                  who, in Orderat's sole discretion, engages in any of the prohibited activities. Prohibited activities
                ...
                <ul className={classes.bullet}>
                  ...
                  <li>
                    <Typography variant="body1" component="p">
                      ...
                      slanderous, hateful, or embarrassing to any other person or entity as determined by Orderat in its
                      sole discretion or pursuant to local community standards;
                    </Typography>
                  </li>
                  <li>
                    <Typography variant="body1" component="p">
                      posting content that constitutes cyber-bullying, as determined by Orderat in its sole discretion;
                    </Typography>
                  </li>
                  <li>
                    <Typography variant="body1" component="p">
                  ...
                  <li>
                    <Typography variant="body1" component="p">
                      posting anything that may be “spam,” as determined by Orderat in its sole discretion;
                    </Typography>
                  </li>
                  <li>
                    <Typography variant="body1" component="p">impersonating another person when posting content;</Typography>
                  </li>
                  <li>
                    <Typography variant="body1" component="p">
                  ...
                  <li>
                    <Typography variant="body1" component="p">
                      ...
                      the Websites, or which, in the sole discretion of Orderat, exposes Orderat or any of its
                  ...
                  <li>
                    <Typography variant="body1" component="p">
                      Orderat reserves the right but is not obligated to do any or all of the following:
                    </Typography>
                  </li>
                  <li>
                    <Typography variant="body1" component="p">
                  ...
                  <li>
                    <Typography variant="body1" component="p">
                      suspend or terminate a user’s access to the Platforms or their Orderat Account upon any breach of
                      these Terms;
                    </Typography>
                  </li>
                  <li>
              ...
              <li>
                ...
                <Typography variant="body1" component="p" className={classes.MV3}>
                  ...
                  Orderat and/or third parties who have authorised us with the use (collectively the “<b>Trademarks</b>
                  ”). You may not use, copy, reproduce, republish, upload, post, transmit, distribute, or modify these
                  Trademarks in any way without our prior express written consent. The use of Orderat's trademarks on
                  any other website not approved by us is strictly prohibited. Orderat will aggressively enforce its
                  intellectual property rights to the fullest extent of the law, including criminal prosecution. Orderat
                  neither warrants nor represents that your use of materials displayed on the Platforms will not
                  infringe rights of third parties not owned by or affiliated with Orderat. Use of any materials on the
              ...
              <li>
                ...
                <ul className={classes.bullet}>
                  ...
                  <li>
                    ...
                    <Typography variant="body1" component="p" className={classes.MV2}>
                      To purchase Alcohol, you must be of the statutory legal age. Orderat, the Vendor and their
                  ...
                  <li>
                    <Typography variant="body1" component="p">
                      To purchase Tobacco, you must be of the statutory legal age. Orderat, the Vendor and their
                      delivery riders, as the case may be, reserve the right in their sole discretion:
                    </Typography>
              ...
              <li>
                ...
                <ul className={classes.bullet}>
                  <li>
                    <Typography variant="body1" component="p">
                      When you place an Order with Orderat, Orderat will confirm your order by sending you a
                  ...
                  <li>
                    <Typography variant="body1" component="p">
                      Special Instructions – Orderat and the Vendor (as the case may be) reasonably endeavour to comply
                      with your special instructions for an Order. However in some cases where this is not feasible,
                      possible or commercially reasonable, Orderat and/or the Vendor reserve the right to proceed to
                      prepare the Order in accordance with standard operating procedures. Neither Orderat nor the Vendor
                  ...
                  <li>
                    <Typography variant="body1" component="p">
                      Allergens – Orderat is not obligated to provide ingredient information or allergen information on
                      the Platforms. Further, Orderat does not guarantee that the Goods sold by Vendors are free of
                  ...
                  <li>
                    <Typography  variant="body1" component="p">
                      Orderat reserves the right to cancel any Order and/or suspend, deactivate or terminate your
                      Orderat account in its sole discretion if it reasonably suspects or detects fraudulent behavior or
                      activity associated with your Orderat account and/or with your Order.{" "}
                    </Typography>
                  </li>
                </ul>
              </li>
              <li>
                ...
                <ul className={classes.bullet}>
                  ...
                  <li>
                    <Typography  variant="body1" component="p">include TAX, VAT or such other equivalent tax; or</Typography>
                  </li>
                  <li>
                    <Typography  variant="body1" component="p">exclude TAX, VAT or such other equivalent tax.</Typography>
                    <Typography  variant="body1" component="p" className={classes.MV2}>
                  ...
                  <li>
                    <Typography  variant="body1" component="p">Delivery fees are chargeable on every Order unless:</Typography>
                  </li>
                  <li>
                    <Typography  variant="body1" component="p">
                  ...
                  <li>
                    <Typography  variant="body1" component="p">unless stated otherwise.</Typography>
                  </li>
                  <li>
                    <Typography  variant="body1" component="p">
                    ...
                    <li>
                      <Typography  variant="body1" component="p">Cash-on-Delivery; or</Typography>
                    </li>
                  </li>
                  <li>
                    <Typography  variant="body1" component="p">Such other payment method we offer from time to time.</Typography>
                  </li>
                  <li>
                    <Typography  variant="body1" component="p">
                      If you have existing credit in your Orderat account or valid promotional or discount vouchers, you
                  ...
                  <li>
                    ...
                    <Typography  variant="body1" component="p" className={classes.MV2}>
                      Orderat reserves the right to offer additional payment methods and/or remove existing payment
                      ...
                      provider(s) for future orders. Orderat does not store your credit card or payment information.
                    </Typography>
                  </li>
                  <li>
                    <Typography  variant="body1" component="p">
                      You must ensure that you have sufficient funds on your credit and debit card to fulfil payment of
                      an Order. Insofar as required, Orderat takes responsibility for payments made on our Platforms
              ...
              <li>
                ...
                <ul className={classes.bullet}>
                  ...
                  <li>
                    <Typography variant="body1" component="p">
                      Orderat shall deliver your Order to the delivery address provided by You. You may choose for your
                      ...
                      ID, Orderat reserves the right not to deliver your Order to you.
                    </Typography>
                  </li>
                  <li>
                    ...
                    <li>
                      ...
                      <li>
                        ...
                        <Typography  variant="body1" component="p" className={classes.MV2}>
                          ...
                          the Order arrives at your delivery address, Orderat reserves the right to cancel the Order
                  ...
                  <li>
                    ...
                    <Typography  variant="body1" component="p" className={classes.MV2}>
                      ...
                      indicated in Clause 1.3 above immediately. In some cases, Orderat may request for photographic
                  ...
                  <li>
                    ...
                    <Typography variant="body1" component="p" className={classes.MV2}>
                      ...
                      event of issues or delays in your delivery. Orderat shall not be responsible in any way for Orders
              ...
              <li>
                ...
                <ul className={classes.bullet}>
                  <li>
                    <Typography variant="body1" component="p">
                      From time to time, Orderat may run marketing and promotional campaigns which offer voucher codes,
                  ...
                  <li>
                    <Typography variant="body1" component="p">Vouchers cannot be exchanged for cash.</Typography>
                  </li>
                  <li>
                    <Typography variant="body1" component="p">
                      Orderat reserves the right to void, discontinue or reject the use of any Voucher without prior
                ...
                <ul className={classes.bullet}>
                  <li>
                    ...
                    <Typography variant="body1" component="p" className={classes.MV2}>
                      ...
                      Orderat makes reasonable efforts to ensure the provision of the Platforms and the services we
                    ...
                    <Typography variant="body1" component="p" className={classes.MV2}>
                      To the extent permitted by law, Orderat (which shall include its employees, directors, agents,
                      ...
                      is to discontinue your use of the Platforms. The Orderat entities, their agents, representatives,
                      ...
                      losses, even if the Orderat entities, their agents, representatives, and service providers have
                      ...
                      Orderat, the Orderat entities, its agents, representatives and service providers' liability shall
                  ...
                  <li>
                    ...
                    <Typography variant="body1" component="p" className={classes.MV2}>
                      Orderat shall neither be liable for actions or omissions of the Vendor nor you in regard to
                      provision of the Goods and where Vendor Delivery applies to your Order. Orderat does not assume
              ...
              <li>
                ...
                <Typography variant="body1" component="p" className={classes.MV3}>
                  ...
                  Delivery, Vendors are responsible for delivery of the Goods and/or Orders. Orderat shall not be liable
              ...
              <li>
                ...
                <Typography variant="body1" component="p" className={classes.MV3}>
                  You agree and consent to Orderat and any of its affiliate companies collecting, using, processing and
              ...
              <li>
                ...
                <Typography variant="body1" component="p" className={classes.MV3}>
                  You agree to indemnify, defend, hold harmless Orderat, its directors, officers, employees,
              ...
              <li>
                ...
                <Typography variant="body1" component="p" className={classes.MV3}>
                  ...
                  agree to do so at your own risk. Orderat does not control or endorse these third party websites or
                  links and shall not be responsible for the content of these linked pages. Orderat accepts no liability
              ...
              <li>
                ...
                <Typography variant="body1" component="p" className={classes.MV3}>
                  Orderat has the right to terminate, suspend or delete your account and access to the Platforms,
                  including any delivery service we provide to you in respect of an Order, for any reason, including,
                  without limitation, if Orderat, in its sole discretion, considers your use to be unacceptable, or in
                  the event of any breach by you of the Terms. Orderat may, but shall be under no obligation to, provide
              ...
              <li>
                ...
                <Typography variant="body1" component="p" className={classes.MV3}>
                  Orderat may amend these Terms at any time in its sole discretion. The amended Terms shall be effective
